...
displaySanPham(listSanPham, 'Chính Trị', "espresso");
displaySanPham(listSanPham, 'Kĩ Năng Sống', "filter_coffee");
displaySanPham(listSanPham, 'Kinh Tế', "tra_macchiato");
displaySanPham(listSanPham, 'Lịch Sử', "coldbrew");
displaySanPham(listSanPham, 'Truyện', "ice_drink");
displaySanPham(listSanPham, 'Văn Hóa', "coffee_bean");
